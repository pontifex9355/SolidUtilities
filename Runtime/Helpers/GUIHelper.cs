...
namespace SolidUtilities
{
	public static class GUIHelper
	{
		...
		public static bool CloseButton(Rect buttonRect) =>
			...
			GUI.Button(buttonRect, GUIContent.none, _closeButtonStyle);
        ...
        public static ScrollView ScrollViewBlock(Rect position, ref Vector2 scrollPosition, Rect viewRect) => new(position, ref scrollPosition, viewRect);
	}
}